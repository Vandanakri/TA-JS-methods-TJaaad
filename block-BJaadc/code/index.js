...
let weather = message.slice("3", "6");
console.log(weather === "you" ? true : false);

// Check and log whether the word from index 7 to 8 is "a" or not

let weather = message.slice("7", "8");
console.log(weather === "you" ? true : false);
...
for(let charecter of messageArray){
  console.log(charecter)
}
